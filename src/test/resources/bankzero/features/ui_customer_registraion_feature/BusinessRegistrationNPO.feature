...
Feature: Business Registration
  @Business_Registration_NPO
  Scenario Outline:Registering An NPI As Voluntary Association (NPO)

    Given I have test data from "business_registration/businessRegistrationNPO_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "business_registration/webdriver_element_list.csv"
      | Take_Screenshot |
      | No              |
    ...
    Examples:
      ...
      | 1                               | BDD        |Accommodation and food service activities  |Accommodation                         |Sub-lease    |Office      |Gauteng  |South Africa |Flat/Apartment/Townhouse|Bid Or Buy|Murray And Roberts|
