...
Scenario Outline: Customer Registration Using GreenID Book and Passport  <Test_Case_Description>

  Given I have test data from "customer_registration/Customer_Registrations_GreenIDBook_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "customer_registration/webdriver_element_list.csv"
    | Take_Screenshot |
    | No              |
  ...
  And I copy "filePathGreenIDBook" file to the phone
  ...
  And I tap "GreenIDbook" web page element
    | Take_Screenshot | Element_Locator_Application_Type |
    | Yes             | ANDROID                           |
...
| No              |
  ...
  And I force click "CheckBox Id Number" web page element
    | Take_Screenshot |
    | No              |
  And I force click "Read Information Barcode" web page element
    | Take_Screenshot |
    | No              |
  And I force click "CheckBox FullName and Surname" web page element
    | Take_Screenshot |
    | No              |
  And I force click "CheckBox Check Country" web page element
    | Take_Screenshot |
    | No              |
  And I force click "CheckBox Valid BirthDate" web page element
    | Take_Screenshot |
    | No              |
...
@GREENIDBOOK_CourierToDifferentResidentialAddress
Scenario Outline:  Customer Registration Using Green IDBook and PassPort Courier to a different address (R99 - R129)  <Test_Case_Description>
...
| 1                               |
  ...
  @Passport_CourierToRetailer
  Scenario Outline:  Customer Registration Using Passport and pick up at Retailer  <Test_Case_Description>
