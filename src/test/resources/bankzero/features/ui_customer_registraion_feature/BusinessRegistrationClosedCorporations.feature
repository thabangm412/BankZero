...
Feature: Business Registration
  ...
  Scenario Outline:Registering A Closed Corporations Business

    Given I have test data from "business_registration/businessRegistrationClosedCorporations_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "business_registration/webdriver_element_list.csv"
      | Take_Screenshot |
      | No              |
    ...
    And I click "ClosedCorporations" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | No              | ANDROID                          |
    ...
    Then "Closed Corporations" should be displayed on "businessType" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes              | ANDROID                          |
    ...
    Examples:
      ...
      | 1                               | BDD        |Accommodation and food service activities  |Accommodation                         |Sub-lease    |Office      |Gauteng  |South Africa |Flat/Apartment/Townhouse|Transnet   |Transnet|
