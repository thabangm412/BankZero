...
Scenario Outline: Customer Registration Using Passport  <Test_Case_Description>

Given I have test data from "customer_registration/Customer_Registrations_Passport_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "customer_registration/webdriver_element_list.csv"
| Take_Screenshot |
| No              |
  ...
  And I tap "SA passport" web page element
    | Take_Screenshot | Element_Locator_Application_Type |
    | Yes             | ANDROID                           |
...
| Take_Screenshot |
| No              |
And I force click "CheckBox CheckEngraving" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox South African" web page element
| Take_Screenshot |
| No              |
...
| Take_Screenshot |
| No              |
And I force click "CheckBox ValidDates Passport" web page element
| Take_Screenshot |
| No              |
...
| Take_Screenshot |
| No              |
And I force click "CheckBox Photo WaterMark" web page element
| Take_Screenshot |
| No              |
...
@PASSPORT_CourierToDifferentResidentialAddress
Scenario Outline:  Customer Registration Using PassPort Courier to a different address (R99 - R129)  <Test_Case_Description>
Given I have test data from "customer_registration/Customer_Registrations_Passport_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "customer_registration/webdriver_element_list.csv"
| Take_Screenshot |
| No              |
