...
Feature: Business Registration
  ...
  Scenario Outline:Registering An Incorporated Partnership Business

    Given I have test data from "business_registration/businessRegistrationIncorporatedPartnership_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "business_registration/webdriver_element_list.csv"
      | Take_Screenshot |
      | No              |
    ...
    And I click "IncorporatedPartnership" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | No              | ANDROID                          |
    ...
    And I click "beneficialOwner" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes              | ANDROID                          |
    ...
    Then "Incorporated Partnership" should be displayed on "businessType" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes              | ANDROID                          |
    ...
    Examples:
      | TestCaseId_and_TestDataRowIndex | keyword    |SIC Group                                  |SIC Industry                          |Ownership    |AddressType|Province |Nationality|TradingAddressType|BusinessName|PartnerShip|
      | 1                               | BDD        |Accommodation and food service activities  |Accommodation                         |Sub-lease    |Office      |Gauteng  |South Africa |Flat/Apartment/Townhouse|Murray And Roberts|Murray And Roberts|
