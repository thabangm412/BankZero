...
Feature: Business Registration
  ...
  Scenario Outline: Gift <Test_Case_Description>

    Given I have test data from "business_registration/businessRegistrationPtyLtd_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "business_registration/webdriver_element_list.csv"
      | Take_Screenshot |
      | No              |
    ...
    And I click "Pty(Ltd)" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | No              | ANDROID                          |

    And I enter a value on "TradingName" text box
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes             | ANDROID                          |
...
#      | Yes             | ANDROID                          |
    ...
    And I enter a value on "ProofSearchBox" text box
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes             | ANDROID                          |
    ...
    And I enter a value on "ResolutionSearchBox" text box
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes             | ANDROID                          |
    ...
    And I click "BeneficialPlusSign" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes              | ANDROID                          |
    ...
    And I enter a value on "BeneficialSearchBox" text box
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes             | ANDROID                          |

    And I click "BeneficialDocument" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes             | ANDROID                          |
