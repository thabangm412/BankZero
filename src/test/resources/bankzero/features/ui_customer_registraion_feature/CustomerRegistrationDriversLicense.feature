...
Feature: Customer Registration For Green ID Book

@Drivers_License_CourierToResidentialAddress_Approve_KYC
Scenario Outline:  Customer Registration Using  Drivers License Courier to residential address (R99 - R129) Approve KYC <Test_Case_Description>

Given I have test data from "customer_registration/Customer_Registrations_DriversLicense_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "customer_registration/webdriver_element_list.csv"
| Take_Screenshot |
| No              |
  ...
  And I copy "filePathLicenceFront" file to the phone
    | Take_Screenshot | Element_Locator_Application_Type |
    | No              | ANDROID                          |

  And I copy "filePathLicenceBack" file to the phone
    | Take_Screenshot | Element_Locator_Application_Type |
    | No              | ANDROID                          |
  ...
  And I tap "SA driving license" web page element
    | Take_Screenshot | Element_Locator_Application_Type |
    | Yes             | ANDROID                           |
  ...
  And I scroll and select document "IdFront" from the device
    | Take_Screenshot | Element_Locator_Application_Type |
    | Yes             | ANDROID                          |
  ...
  And I scroll and select document "IdBack" from the device
    | Take_Screenshot | Element_Locator_Application_Type |
    | Yes             | ANDROID                          |
...
| Yes             | ANDROID                          |
  ...
  And I force click "Id Document" web page element
    | Take_Screenshot |
    | No              |
And I force click "CheckBox Initials Captured" web page element
| Take_Screenshot |
| No              |
And I force click "Id Number" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox birth date" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Valid Dates" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Signature" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Valid DriversLicense" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox PhotoTempering" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Valid WaterMark" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Compare Photo with Selfie" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Encrypted 2D Barcode" web page element
| Take_Screenshot |
| No              |
And I force click "CheckBox Thumb Print" web page element
| Take_Screenshot |
| No              |
...
@Drivers_License_CourierToDifferentResidentialAddress
Scenario Outline:  Customer Registration Using Drivers License Courier to a different address (R99 - R129) <Test_Case_Description>
...
| Take_Screenshot |
| Yes             |
And I click "Login Button" web page element website
| Take_Screenshot |
| No              |
And I force click "Navbar Dropdown" web page element
| Take_Screenshot |
...
@Drivers_License_CourierUpAtRetail
  Scenario Outline:  Customer Registration Using Drivers License Pick up at retailer (R59) <Test_Case_Description>
