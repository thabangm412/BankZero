...
Feature: Business Registration
  ...
  Scenario Outline:Registering An NPI Per Companies Act (NPC)

    Given I have test data from "business_registration/businessRegistrationNPC_Data.csv" at row number "<TestCaseId_and_TestDataRowIndex>" with web page elements listed on "business_registration/webdriver_element_list.csv"
      | Take_Screenshot |
      | No              |
...
#      | No              | ANDROID                          |
#
#    And I click "NPC" web page element
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | No              | ANDROID                          |
#
...
#      | No              | ANDROID                          |
#
#    And I scroll using xpath containing "CardOption"
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes              | ANDROID                         |
#
#    And I click "nextBtn" web page element
...
#      | Yes             | ANDROID                          |
#
#    And I click "addAsIncorporator" web page element
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes              | ANDROID                          |
#
...
#      | Yes              | ANDROID                          |
#
#    And I click "Incorporator" web page element
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes              | ANDROID                          |
#
...
#      | Yes              | ANDROID                          |
#
#    When I scroll using xpath containing "Nationality"
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes              | ANDROID                         |
#
...
#      | Yes              | ANDROID                          |
#
#    And I click "addOwner2PlusSign" web page element
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | No              | ANDROID                          |
#
#    And I enter a value on "Owner2PreferedName" text box
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes             | ANDROID                          |
#
#    And I click "Director" web page element
...
#      | Yes              | ANDROID                         |
#
#    And I enter a value on "Owner2CellNo" text box
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes             | ANDROID                          |
#
#    And I click "addBtn" web page element
...
#      | Yes              | ANDROID                          |
#
#    Then "OrganisationName" should be displayed on "entityName" web page element
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes              | ANDROID                          |
#
#    Then "OrganisationName" should be displayed on "businessName" web page element
#      | Take_Screenshot | Element_Locator_Application_Type |
#      | Yes              | ANDROID                          |
#
...
#      | Yes              | ANDROID                          |
    ...
    And I click "proofPlusSign" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes              | ANDROID                          |
    ...
    And I click "proofDocument" web page element
      | Take_Screenshot | Element_Locator_Application_Type |
      | Yes             | ANDROID                          |
